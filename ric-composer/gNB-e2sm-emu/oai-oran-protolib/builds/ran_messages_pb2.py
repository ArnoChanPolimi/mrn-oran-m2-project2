...
_UE_INFO_M = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='dl_ber', full_name='ue_info_m.dl_ber', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='dl_mcs', full_name='ue_info_m.dl_mcs', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='target_dl_mcs', full_name='ue_info_m.target_dl_mcs', index=8,
