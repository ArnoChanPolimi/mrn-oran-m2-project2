...
struct  _UeInfoM
{
  ...
  float prop_2;
  /*
   * Project 2: downlink BER monitoring and MCS control
   */
  protobuf_c_boolean has_dl_ber;
  float dl_ber;
  protobuf_c_boolean has_dl_mcs;
  int32_t dl_mcs;
  protobuf_c_boolean has_target_dl_mcs;
  int32_t target_dl_mcs;
};
