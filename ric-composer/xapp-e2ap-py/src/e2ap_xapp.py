...
#        sub_mgr = SubscriptionManager(rmr_xapp)
    ...
    def send_e2ap_sub_request(self,payload, gnb_id):
        ...
        subsequent_action.is_valid = 1
        subsequent_action.subsequent_action_type = 1
        # RICtimeToWait_w500ms = 11 in E2AP v1.01, but the bundled encoder
        # crashes when this optional subsequent action is attached. The e2sim
        # report loop is forced to 500 ms by run_e2ap_agent.sh instead.
        subsequent_action.time_to_wait = 11
        # subsequent_actions.append(subsequent_action)
